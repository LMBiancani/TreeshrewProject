...
* In SISRS step 7a, the taxa threshold parameter (T) was set to T=4. The coverage and heterozygosity thresholds were left as defaults (3 and 0.01 respectively)
