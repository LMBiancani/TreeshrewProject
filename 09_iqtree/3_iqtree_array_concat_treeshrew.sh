...
#SBATCH --output=/scratch3/workspace/yana_hrytsenko_uri_edu-shared/Projects/TreeshrewProject/09_iqtree/slurm_outs/step_3_outs/IQarr_%A_%a_trshrw.out
...
#NOTE: all the outputs from this step were moved to /scratch3/workspace/yana_hrytsenko_uri_edu-shared/Projects/TreeshrewProject/09_iqtree/step3_concat_treeshrew_out_files/
