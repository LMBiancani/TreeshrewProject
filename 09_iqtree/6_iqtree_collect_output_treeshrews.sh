...
#SBATCH --output=/scratch3/workspace/yana_hrytsenko_uri_edu-shared/Projects/TreeshrewProject/09_iqtree/slurm_outs/step_6_outs/IQout_trsrw.out

cd $SLURM_SUBMIT_DIR

date
assessment_folder="/scratch3/workspace/yana_hrytsenko_uri_edu-shared/Projects/TreeshrewProject/SISRS/post_processing/iqtree_assessment_treeshrew/"

output_prefix="combined_iqtree_treeshrew"


cat /scratch3/workspace/yana_hrytsenko_uri_edu-shared/Projects/TreeshrewProject/09_iqtree/LnLs_outs_treeshrew/LnLs_*.csv > ${output_prefix}_dLnLs.csv
