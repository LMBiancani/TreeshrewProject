...
#SBATCH --output=/scratch3/workspace/yana_hrytsenko_uri_edu-shared/Projects/TreeshrewProject/09_iqtree/slurm_outs/step_2_outs/IQarr_%A_%a_treeshrew.out
...
scf_out_treeshrew="/scratch3/workspace/yana_hrytsenko_uri_edu-shared/Projects/TreeshrewProject/SISRS/post_processing/iqtree_assessment_treeshrew/"

LnLS_outs_treeshrew="/scratch3/workspace/yana_hrytsenko_uri_edu-shared/Projects/TreeshrewProject/09_iqtree/LnLs_outs_treeshrew/"
...
trees_to_eval="/scratch3/workspace/yana_hrytsenko_uri_edu-shared/Projects/TreeshrewProject/09_iqtree/select-files_focal_tips/treeshrew_trees_to_fit.tre"

#Focal tips for hypothesis Tree 1: treeshrews.
focal_tips1="/scratch3/workspace/yana_hrytsenko_uri_edu-shared/Projects/TreeshrewProject/09_iqtree/select-files_focal_tips/focal_tips.txt"

#Focal tips for hypothesis Tree 2: This is all remaining species once you know treeshrew and primates and outgroup, so this is also Glires.
focal_tips2="/scratch3/workspace/yana_hrytsenko_uri_edu-shared/Projects/TreeshrewProject/09_iqtree/select-files_focal_tips/focal_tips.txt"

#Focal tips for hypothesis Tree 3: Primates.
focal_tips3="/scratch3/workspace/yana_hrytsenko_uri_edu-shared/Projects/TreeshrewProject/09_iqtree/select-files_focal_tips/focal_tips2.txt"
...
> ${LnLS_outs_treeshrew}LnLs_${SLURM_ARRAY_TASK_ID}.csv
cat ${scf_out_treeshrew}${fileline} | while read line
do
	echo $line
	...
	echo $line","$(grep "Tree 1 / LogL:" calcLnL_${line}.log | cut -f2 -d: )","$(grep "Tree 2 / LogL:" calcLnL_${line}.log | cut -f2 -d: )","$(grep "Tree 3 / LogL:" calcLnL_${line}.log | cut -f2 -d: ) >> ${LnLS_outs_treeshrew}LnLs_${SLURM_ARRAY_TASK_ID}.csv
	...
	rm ./tree1_${line}.tre
	echo "ID,sCF,sCF_N,sDF1,sDF1_N,sDF2,sDF2_N,sN,debug" > ${scf_out_treeshrew}scf/scf_${line}
	Rscript ${scripts_dir}getSCF.R concord1_${line}.cf.branch concord1_${line}.cf.stat ${focal_tips1} ${outgroup_tips} >> ${scf_out_treeshrew}scf/scf_${line}
	...
	rm ./tree2_${line}.tre
	Rscript ${scripts_dir}getSCF.R concord2_${line}.cf.branch concord2_${line}.cf.stat ${focal_tips2} ${outgroup_tips} >> ${scf_out_treeshrew}scf/scf_${line}
	...
	rm ./tree3_${line}.tre
	Rscript ${scripts_dir}getSCF.R concord3_${line}.cf.branch concord3_${line}.cf.stat ${focal_tips3} ${outgroup_tips} >> ${scf_out_treeshrew}scf/scf_${line}
